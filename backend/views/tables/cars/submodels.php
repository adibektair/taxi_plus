        ...
        <div class="col-sm-12 col-lg-12">
            <div class="panel">
                <div class="panel-body">
                    ...
                    <?
                    Yii::$app->session->set('last_car', $model->id);
                    ?>
                    <table class="table">
                        <thead>
                        <tr>
    ...
    $(function() {
        ...
        $('.table').DataTable({
            ...
            "ajax":{
                ...
                type: "GET",
                data: {"_csrf-backend":token, table:"car_models", name:"cars/submodels", id: <?=$model->id?>}
            },
            "stateSave": true,
            ...
            aoColumns: [
                ...
                {"mData": {},
                    "mRender": function (data, type, row) {
                        return '<label class="text-semibold">'+ data.model + '</label>';
                    }
                }
            ]
        });
