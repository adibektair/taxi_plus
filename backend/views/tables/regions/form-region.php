...
<!---LOCAL --->
<script type="text/javascript" src="/profile/files/js/mytables/regions/form.js"></script>
<!------->
            ...
            <div class="panel-body">
                <div class="col-md-12">
                    <div class="col-md-12">
                        ...
                        <?=$this->render('/layouts/modal-components/_input', array('info' => array("Название региона", "name", "text", $model->name, "true", "Акмолинская область")))?>
                    </div>
                    ...
                    <div class = "col-md-12">
                        <div class="text-right">
                            ...
                            <? if ($model->id != null) { ?>
                                <a href = "#delete" data-id = "<?=$model->id?>" data-table = "regions" data-redirect = "regions" class="delete btn btn-danger">Удалить <i class="icon-trash-alt position-right"></i></a>
                            <? } ?>
