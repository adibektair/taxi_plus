        ...
        <div class="col-sm-12 col-lg-12">
            <div class="panel">
                <div class="panel-body">
                    ...
                    <?
                    Yii::$app->session->set('last_client_id', $model->id);
                    Yii::$app->session->set('last_client_info', $info);
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                            <th>ID</th>
                            <th>Всего заказов</th>
                            <th>Рассчет за наличные</th>
                            <th>Рассчет банковскими картами</th>
                            <th>Расчет бонусными монетами</th>
                        </tr>
                        </thead>
                        <tbody>
                        </tbody>
    ...
    $(function() {
        ...
        $('.table').DataTable({
            ...
            "ajax":{
                ...
                type: "GET",
                data: {"_csrf-backend":token, table:"users", name:"stats_clients/client-stat", id: <?=$model->id?>}
            },
            "stateSave": true,
            ...
            aoColumns: [
                ...
                {"mData": {},
                    "mRender": function (data, type, row) {
                        ...
                        return '<label class="text-semibold">'+ data.nal + '</label>';
                    }
                },
                {"mData": {},
                    "mRender": function (data, type, row) {

                        return '<label class="text-semibold">'+ data.beznal + '</label>';
                    }
                },
                {"mData": {},
                    "mRender": function (data, type, row) {
