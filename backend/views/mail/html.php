                                    ...
                                    <table width="560" align="center" cellpadding="0" cellspacing="0" border="0" class="devicewidthinner">
                                        ...
                                        <tr>
                                            <td style="font-family: Helvetica, arial, sans-serif; font-size: 14px; font-weight:bold; color: #333333; text-align:left;line-height: 24px;">
                                                Добро пожаловать на проект asd Pricelist!
                                            </td>
                                        </tr>
                                        <!-- End of Title -->
                                        <!-- spacing -->
                                        ...
                                        <tr>
                                            <td style="font-family: Helvetica, arial, sans-serif; font-size: 13px; color: #333333; text-align:left;line-height: 24px;">
                                                Вы были зарегистрированы как <strong><?=$this->params['role']?></strong>.<br/>
                                                <div style = "margin-top:10px;">
                                                    <strong>Ваши данные для входа на сайт:</strong><br/>
                                                    Логин: <?=$this->params['email']?><br/>
                                                    Пароль: <?=$this->params['password']?>
                                                </div>
                                            </td>
                                        </tr>
                                        <!-- End of content -->
                                        ...
                                        <tr>
                                            <td style="font-family: Helvetica, arial, sans-serif; font-size: 13px; font-weight:bold; color: #333333; text-align:left;line-height: 24px;">
                                                <a href="https://pricelist.maint.kz/profile/" style="color:grey;text-decoration:none;font-weight:bold;">перейти на страницу авторизации</a>
                                            </td>
                                        </tr>
                                        <!-- /button -->
                                        <!-- Spacing -->
...
<table width="100%" bgcolor="#e8eaed" cellpadding="0" cellspacing="0" border="0" id="backgroundTable">
    ...
    <tr>
        <td>
            <table bgcolor="#202020" width="600" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth">
                <tbody>
                <tr>
                    <td width="100%">
                        <table width="600" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth">
                            <tbody>
                                ...
                                <tr>
                                    <td align="center" valign="middle" style="font-family: Helvetica, arial, sans-serif; font-size: 13px;color: #ffffff!important">
                                        Если у Вас есть вопросы, звоните по номеру +7 (707) 276 000 6</a>
                                    </td>
                                </tr>
                                <tr>
                                    <td width="100%" height="20"></td>
